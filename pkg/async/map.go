...
func Map[T any, R any](collection []T, iteratee MapIteratee[T, R]) []R {
	r, _ := AsyncMapI(nil, collection, func(_ context.Context, t T, _ int) (R, error) {
...
func MapI[T any, R any](collection []T, iteratee MapIterateeI[T, R]) []R {
	r, _ := AsyncMapI(nil, collection, func(_ context.Context, t T, i int) (R, error) {
		return iteratee(t, i), nil
	})
	return r
}

func AsyncMap[T any, R any](ctx context.Context, collection []T, iteratee MapAsyncIteratee[T, R]) ([]R, error) {
	return AsyncMapI(ctx, collection, func(ctx context.Context, t T, _ int) (R, error) {
		return iteratee(ctx, t)
	})
}

func AsyncMapI[T any, R any](ctx context.Context, collection []T, iteratee MapAsyncIterateeI[T, R]) ([]R, error) {
